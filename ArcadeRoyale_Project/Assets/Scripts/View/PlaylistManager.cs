...
public class PlaylistManager : MonoBehaviour {
    ...
    public void selectGame() {
        ...
        if (!waiting) {
            ...
            Debug.Log("GM instance: '" + GM.Instance.gameObject );//+"'    Runner component: '" + GM.Instance.GetComponent<Runner>() + "'    playlist: '" + playlist.name + "'     playlist games count: " + playlist.games.Count + "    selected game index: " + selectedGameIndex );
            GM.Instance.GetComponent<Runner>().Run(playlist.games[selectedGameIndex]);
        }
    }
