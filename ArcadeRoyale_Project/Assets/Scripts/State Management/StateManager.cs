...
public class StateManager : MonoBehaviour {
    ...
    public List<GameObject> objectsToToggleActivation;
	...
	public void Deactivate() {
        ...
        foreach (GameObject obj in objectsToToggleActivation) obj.SetActive(false);   
	...
	public void Activate() {
        ...
        foreach (GameObject obj in objectsToToggleActivation) obj.SetActive(true);            
